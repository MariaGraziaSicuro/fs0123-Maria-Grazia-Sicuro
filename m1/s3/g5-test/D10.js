...
*/
   ...
   function deleteOne(stringa, boooleano){                         
    if(boooleano === true){                                        
   return stringa.slice(1)                                  
    ...
    console.log(deleteOne('uffa', true))
    console.log(deleteOne('uffa', false))
/* ESERCIZIO 5
...
function onlyLetters(str) {
  nientenumeri = str.replace (/ [0-9] /, " ");
  return nientenumeri
}
 console.log(onlyLetters("Ho 1 cane"));
...
*/
  ...
  /* console.log(isThisAnEmail('merysi@libero.it'))*/
/* ESERCIZIO 7
...
function countMovies() {
  let a = movies.filter(movie => movie.Type === 'movie')
  return a.length
}
...
*/
function idFalso(){
  let idFalso = document.getElementById('container');        
  return (idFalso);
}
 idFalso()
/* ESERCIZIO 21
...
*/
 function pizza() {
  let pizza = document.getElementById('td');
 }
/* ESERCIZIO 22
